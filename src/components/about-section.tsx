          ...
          <div className="lg:col-span-2 flex items-center justify-center lg:justify-end">
             <Card className="overflow-hidden rounded-xl shadow-xl border-none w-full max-w-md lg:max-w-sm aspect-[4/5]">
               <CardContent className="p-0 h-full">
                  <Image
                    src="https://picsum.photos/seed/bharat-profile/600/750" // Using placeholder
                    alt="Bharat Singh Parihar - Portrait"
                    width={600}
                    height={750}
                    className="object-cover w-full h-full"
                    priority // Load image eagerly as it's important
                    data-ai-hint="young indian man suit university building background portrait professional student developer" // Refreshed hint
                  />
               </CardContent>
              </Card>
          </div>
